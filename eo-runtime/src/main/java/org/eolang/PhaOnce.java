...
public final class PhaOnce implements Phi {
    ...
    @Override
    public Phi copy() {
        return new PhaOnce(this.origin.copy());
    }

    @Override
    public boolean hasRho() {
        return this.cached.get().hasRho();
    }
    ...
    public String locator() {
        return this.cached.get().locator();
    }

    @Override
    public String forma() {
        return this.cached.get().forma();
    }

    @Override
    public byte[] delta() {
        return this.cached.get().delta();
    }
}
